    ...
    return(
        <div className='sm:space-y-2'>
            <div className='flex gap-2.5 items-center sm:items-end sm:py-1'>
                ...
                <h2 className='hidden sm:flex gap-1.5 text-xs sm:text-base text-gray-300 opacity-50'>Best heroes to play <div className={`${type == 'against' ? 'text-red-200' : 'text-blue-200'} font-bold`}>{type}</div> {hero.localized_name}</h2>
            </div>
