                    ...
                    {levels.map((level, index) => (
                        <div className='space-y-3'>
                            <div className="flex items-center space-x-3 px-4">
                                <div className={`w-40 h-12 p-1 rounded-md text-center ${bestTalents.includes(leftTalents[index]) ? 'bg-slate-800 font-bold text-slate-300 border border-slate-700' : 'text-slate-300/50'}`}>
                                    {leftTalents[index]}
                                </div>
                                ...
                                <div className={`w-40 h-12 p-1 rounded-md text-center ${bestTalents.includes(rightTalents[index]) ? 'bg-slate-800 font-bold text-slate-300 border border-slate-700' : 'text-slate-300/50'}`}>
                                    {rightTalents[index]}
                                </div>
                            </div>
                            {index < 0 ? (
