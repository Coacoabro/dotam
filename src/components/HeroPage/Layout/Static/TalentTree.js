...
export default function TalentTree({ talents }) {
    ...
    return (
        <div className="relative">
            ...
            {toolTip && (
                <div
                    className="fixed sm:absolute sm:w-[500px] sm:top-[110%] sm:left-1/2 sm:-translate-x-1/2 sm:transform top-100 rounded-lg left-8 flex items-center justify-center bg-black bg-opacity-75 z-30"
                    style={{
